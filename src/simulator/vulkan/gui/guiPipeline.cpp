...
void GuiPipeline::render(VkCommandBuffer commandBuffer, int imageIndex)
{
	...
	objectInfo.position = glm::vec2(-0.8,-0.8);
	objectInfo.size = glm::vec2(1.0,0.2);
	objectInfo.radius = 0.04;
	objectInfo.color = glm::vec4(0.6,0.3,0.3,0.5);
