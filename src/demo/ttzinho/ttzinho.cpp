...
Ttzinho::Ttzinho()
{
	...
	ImportedObject* wheelL = new ImportedObject("Wheel left", "wheel", {0.2,0.06,0}, {0,0,90}, {1,1,1}, 0.1f, new btCylinderShape(btVector3(0.06, 0.01, 0.06)));
	ImportedObject* wheelR = new ImportedObject("Wheel right", "wheel", {-0.2,0.06,0}, {0,0,0}, {1,1,1}, 0.1f, new btCylinderShape(btVector3(0.06, 0.01, 0.06)));
