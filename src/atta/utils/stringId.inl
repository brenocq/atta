...
inline bool StringId::operator==(std::string str) const { return getString() == str; }

inline bool StringId::operator==(const char* str) const { return getString() == std::string(str); }

inline bool StringId::operator==(StringId sid) const { return _id == sid._id; }
...
inline bool StringId::operator<(StringId other) const { return _id < other._id; }
