...
namespace atta
{
		...
		Pipeline(vkCore, {imageView}, scene)
	{
		...
		//---------- Shaders ----------//
		_vertShaderModule = std::make_shared<vk::ShaderModule>(_device, "/usr/include/atta/assets/shaders/renderer2D/renderer2D.vert.spv");
		_fragShaderModule = std::make_shared<vk::ShaderModule>(_device, "/usr/include/atta/assets/shaders/renderer2D/renderer2D.frag.spv");
