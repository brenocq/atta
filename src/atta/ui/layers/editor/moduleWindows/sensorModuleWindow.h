...
//--------------------------------------------------
#ifndef ATTA_UI_LAYERS_EDITOR_WINDOWS_SENSOR_MODULE_WINDOW_H
#define ATTA_UI_LAYERS_EDITOR_WINDOWS_SENSOR_MODULE_WINDOW_H
...
#endif // ATTA_UI_LAYERS_EDITOR_WINDOWS_SENSOR_MODULE_WINDOW_H
