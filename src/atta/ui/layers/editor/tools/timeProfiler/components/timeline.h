...
//--------------------------------------------------
#ifndef ATTA_UI_LAYERS_EDITOR_TOOLS_TIME_PROFILER_COMPONENTS_TIMELINE_H
#define ATTA_UI_LAYERS_EDITOR_TOOLS_TIME_PROFILER_COMPONENTS_TIMELINE_H
...
#endif // ATTA_UI_LAYERS_EDITOR_TOOLS_TIME_PROFILER_COMPONENTS_TIMELINE_H
