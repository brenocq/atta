...
//--------------------------------------------------
#ifndef ATTA_UI_EDITOR_WINDOWS_UTILS_FILE_SELECTION_WINDOW_H
#define ATTA_UI_EDITOR_WINDOWS_UTILS_FILE_SELECTION_WINDOW_H
...
#endif // ATTA_UI_EDITOR_WINDOWS_UTILS_FILE_SELECTION_WINDOW_H
