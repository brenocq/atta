...
//--------------------------------------------------
#ifndef ATTA_UI_PANELS_MENU_BAR_LOCAL_WINDOWS_REPO_WINDOW_H
#define ATTA_UI_PANELS_MENU_BAR_LOCAL_WINDOWS_REPO_WINDOW_H
...
#endif // ATTA_UI_PANELS_MENU_BAR_LOCAL_WINDOWS_REPO_WINDOW_H
