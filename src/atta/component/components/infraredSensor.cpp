...
ComponentDescription& TypedComponentRegistry<InfraredSensor>::getDescription() {
    static ComponentDescription desc = {
        "Infrared Sensor",
        {
            ...
            {AttributeType::FLOAT32, offsetof(InfraredSensor, lowerRange), "lowerRange", 0.0f, 1.0f, 0.001f},
            {AttributeType::FLOAT32, offsetof(InfraredSensor, upperRange), "upperRange", 0.0f, 1.0f, 0.001f},
