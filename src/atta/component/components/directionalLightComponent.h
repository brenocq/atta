...
//--------------------------------------------------
#ifndef ATTA_COMPONENT_COMPONENTS_DIRECTIONAL_LIGHT_COMPONENT_H
#define ATTA_COMPONENT_COMPONENTS_DIRECTIONAL_LIGHT_COMPONENT_H
...
#endif// ATTA_COMPONENT_COMPONENTS_DIRECTIONAL_LIGHT_COMPONENT_H
